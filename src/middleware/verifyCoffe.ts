...
export const verifyAddCoffe = (request: Request, response: Response, next: NextFunction) => {
...
export const verifyEditCoffe = (request: Request, response: Response, next: NextFunction) => {
    /** validate a request body and grab error if exist */
